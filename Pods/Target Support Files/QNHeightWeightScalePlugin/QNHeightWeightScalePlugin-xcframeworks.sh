...
install_xcframework "${PODS_ROOT}/QNHeightWeightScalePlugin/QNHeightWeightScalePluginLibrary.xcframework" "QNHeightWeightScalePluginLibrary" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
